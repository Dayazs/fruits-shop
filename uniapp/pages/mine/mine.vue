...
<script setup>
	...
	const orderStatuses = [{
			label: '待付款',
			icon: '/static/icons/non-payment.svg'
		},
		{
			label: '待发货',
			icon: '/static/icons/not_yet_shipped.svg'
		},
		{
			label: '已发货',
			icon: '/static/icons/shipped.svg'
		},
		{
			label: '交易完成',
			icon: '/static/icons/complete_transaction.svg'
		},
		{
			label: '交易关闭',
			icon: '/static/icons/transaction_closed.svg'
		}
	]
